...
function previewUsageRecord(options: PreviewUsageRecordOptions): UsageListRecord {
  ...
  return {
    id: options.id,
    responseTurnStateByteLength: options.provider === 'openai' ? 292 : null,
  ...
  accountUsage: [
    {
      ...
      usageWindow: {
        ...
        role: 'primary',
        labelDisplay: '5 小时',
        windowLabelDisplay: '5 小时',
        windowSeconds: 18_000,
        usedPercent: 32,
        usedPercentDisplay: '32%',
        limitReached: false,
        resetAtDisplay: '—',
      },
      lastUsed: '刚刚',
